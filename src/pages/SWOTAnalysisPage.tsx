      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-8 border-b border-slate-200">
        <div>
          ...
          <p className="text-base text-slate-600 mt-2 font-medium max-w-2xl">
            Comprehensive SWOT (Strengths, Weaknesses, Opportunities, Threats) analysis powered by OpenRouter AI. All insights are tactical, actionable, and operational.
          </p>
        </div>
        <button
        ...
        <>
          ...
          >
            <p className="text-sm text-slate-600">
              ...
              SWOT analysis generated by OpenRouter Qwen AI model • 
