    ...
    >
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-8 border-b border-slate-200">
        <div>
          ...
          <p className="text-base text-slate-600 dark:text-slate-400 mt-2 font-medium max-w-2xl">
        ...
        <button
          ...
          className={cn(
            ...
            isRegenerating || loading
              ? "bg-slate-100 text-slate-600 dark:bg-slate-800 dark:text-slate-400 cursor-not-allowed"
      ...
      {loading && (
        ...
        >
          ...
          <p className="text-slate-600 dark:text-slate-400">Analyzing your operational metrics with AI to generate tactical insights.</p>
        </motion.div>
      )}
